...
//const char* mqtt_server = "192.168.1.198";   // Replace with your Pi's IP
...
// --- WiFi Credentials (use char arrays instead of const char*) ---
char ssid[] = "XIII";
char wifi_password[] = "Danny1258";

// --- MQTT Broker (Raspberry Pi) ---
const char* mqtt_server = "10.177.62.197";   // Replace with your Pi's IP
const int mqtt_port = 1883;
const char* mqtt_user = "fireuser";
const char* mqtt_password = "admin";  // Replace with actual password
...
// Helper function to convert IPAddress to String (since .toString() is not available)
...
void setup() {
  ...
  // Connect to Wi-Fi (now ssid and wifi_password are char arrays, no casting needed)
  WiFi.begin(ssid, wifi_password);
  Serial.print("Connecting to WiFi");
  while (WiFi.status() != WL_CONNECTED) {
    delay(500);
  ...
  // Fixed: use helper function instead of .toString()
